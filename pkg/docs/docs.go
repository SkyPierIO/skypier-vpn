                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/vpn.ConnectionDetails"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        "vpn.ConnectionDetails": {
            ...
            "properties": {
                ...
                "ipNegotiated": {
                    "description": "Whether IP negotiation has been completed",
                    "type": "boolean"
                },
                "isRunning": {
                ...
                "localIp": {
                    "description": "Local IP for this TUN interface",
                    "type": "string"
                },
                "origLocalIp": {
                    "description": "Original local IP (before negotiation)",
                    "type": "string"
                },
                "origRemoteIp": {
                    "description": "Original remote IP (before negotiation)",
                    "type": "string"
                },
                "peerId": {
                ...
                "remoteIp": {
                    "description": "Remote IP for this TUN interface",
                    "type": "string"
                },
                "streamActive": {
                    "description": "Whether the stream is active (not closed)",
                    "type": "boolean"
                }
            }
        }
